...
if __name__ == "__main__":
    ...
    door = State('pppppppppp  f    b  ')
    moveBlockDownTo(5, -2, door)
    l1 = len(door.moves)
    end1 = time_ns()
    ...
    # Large
    begin2 = time_ns()
    door = State('pppppppppppppppppppppppppp  f         b  ')
    moveBlockDownTo(10, -2, door)
    l2 = len(door.moves)
    end2 = time_ns()

    print(log)
    print(f'{l1}/386, {l2}/16595')
    print(f'{100*(1-(l1 + l2)/(386+16595))}% Improvement!')
